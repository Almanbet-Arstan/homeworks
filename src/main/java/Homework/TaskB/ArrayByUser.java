...
public class ArrayByUser {
    ...
    //метод который создает размер массива от 1 до 10
    public static int createSizeArray() {
        return new Random().nextInt(10 + 1 - 1) + 1;
    }
    //метод который создает массив с указанным размером и с рандомными значениями от 1 до 100
    ...
    //метод который высчитывает количество чисел от и до и считывает их среднее ариф-ое
